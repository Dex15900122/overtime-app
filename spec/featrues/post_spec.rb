...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, rationable: "Rationable",user_id: user.id ,overtime_request: 3.5)
  end
  ...
  describe 'index' do
    ...
    it 'has a list of posts' do
     ...
     it 'has a scope so that only post creators can see their posts' do
      ...
      post_from_other_user = Post.create(date: Date.today, rationable: "This post shouldn't be seen", user_id: other_user.id,overtime_request: 3.5)
  ...
  describe "delete" do 
    it 'can be deleted ' do 
      ...
      post_to_delete = Post.create(date: Date.today,rationable: "asdf", user_id: delete_user.id, overtime_request: 3.5)
      visit posts_path
  ...
  describe "creation" do
    ...
    it 'can be edited' do
      ...
      fill_in 'post[date]', with: Date.today
      fill_in 'post[rationalbe]', with: "Edited content"
      click_on "Save"
